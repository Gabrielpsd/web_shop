        ...
        excluiCadastro(){
                ...
                request.onload = function(){
                    if(this.readyState == XMLHttpRequest.DONE)
                        if(this.status == 209)
                        {
                            if(obj.fornecedor == true)
                                obj.modalMensagem = {titulo: 'Fornecedor não pode ser excluido', mensagem :'Fornecedor já esta em um pedido'}
                            else
                                obj.modalMensagem = {titulo: 'Cliente não pode ser excluido', mensagem :'Cliente já esta em um pedido'}
